...
def run_experiment(tStart, v=1):
    ...
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~TEST~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
    zLog = numpy.zeros((T, 2))
    zCapture = numpy.empty((1, 2))
    testSaveName = input('Put the path and name of where you want to save this test: ')
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~TEST~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
    ...
    for t in range(tStart, T):
        ...
        for spm in range(spmN):
            ...
            if t == 0:
                ...
                a = 0
                # gvIn, dpIn = new_GV(xy, t)  # Find the new growth vector given the position of the root tip
                # GV[spm, 0] = gvIn[0, 0]
                # GV[spm, 1] = gvIn[0, 1]
                # dp[spm, 0] = dpIn[0, 0]
                # dp[spm, 1] = dpIn[0, 1]
            ...
            if t == 0:
                ...
                Ieval = simulations.cut_image(I[:, :, :, 0], t)

            print(Ieval.shape)
            z[spm, 0], z[spm, 1] = find_Z_Range(Ieval)  # Get the range of z stacks that are to be imaged according to where the signal is
            # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~TEST~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#

        print('Saving new positions into database')
        dataHandle.new_mic_positions(GV, dp, z, t)

        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~TEST~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
        zLog[t, 0] = z[0, 0]
        zLog[t, 1] = z[0, 1]
        print('Writing 3D image')
        if t == 0:
            Ieval = Ieval[:, :, int(z[spm, 0]-3):int(z[spm, 1]+4)]
        imwrite3d(Ieval, testSaveName + '/axial_T' + str(t) + '.tif')
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~TEST~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
